...
namespace Hotel
{
    public partial class Frm_Order : Form
    {
        ...
        {
            int paymentID = Convert.ToInt32(PaymentdataGridView.CurrentRow.Cells["付款方式編號"].Value);
        ...
        //    DateTime outtime = DateTime.ParseExact(OutdateTimePicker.Value.ToString("yyyy-MM-dd") + " 11:00:00", "yyyy-MM-dd HH:mm:ss", CultureInfo.InvariantCulture);
        ...
        private void btnaddOrder_Click(object sender, EventArgs e)
        {
            ...
            int paymentID = this.ODPaymentID;
            ...
            OrderDetail od = new OrderDetail
            {
                ...
                MoveInDate = DateTime.ParseExact(IndateTimePicker1.Value.ToString("yyyy-MM-dd") + " 14:00:00", "yyyy-MM-dd HH:mm:ss", CultureInfo.InvariantCulture),
                MoveOutDate = DateTime.ParseExact(OutdateTimePicker1.Value.ToString("yyyy-MM-dd") + " 11:00:00", "yyyy-MM-dd HH:mm:ss", CultureInfo.InvariantCulture),
